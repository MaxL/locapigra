/*
* Stolen from Julian Garnier and his great anime.js front page
* http://anime-js.com/
* thanks :* !
*/
...
var fireworks = function() {
  ...
  var loca = document.querySelector('.loca-logo');
  ...
  var setCanvasSize = function() {
    canvas.width = $(loca).outerWidth(true);
    canvas.height = $(loca).outerHeight(true);
  }
